...
SKILLS = [
    ...
    {
        "skill_id": "dan-literature-stack",
        "pack_id": "literature-stack",
        "dir_name": "literature-stack",
        "title_zh": "文献采集、Zotero 项目管理与综述工作流",
        "title_en": "Literature Acquisition, Zotero Project Management, and Review Workflows",
        "description_zh": "把 Google Scholar、CNKI、Zotero MCP 和综述产出串成一条可执行的文献采集与项目管理工作流。",
        "description_en": "Connect Google Scholar, CNKI, Zotero MCP, and review generation into one executable literature operations workflow.",
        "triggers": [
        ...
        "chapter_file": None,
        "source_themes": ["literature", "tools"],
        "pack_summary_zh": "这个知识包把 Google Scholar/CNKI 检索、Zotero 入库与项目管理、以及后续文献综述准备串成一条可执行工作流，重点是让采集、整理和综述生成在同一个研究栈里衔接起来。",
        "pack_summary_en": "This pack turns Google Scholar/CNKI collection, Zotero-based project organization, and review preparation into one connected literature operations stack.",
        "concepts": [
        ...
        "frameworks": [
            {
                "title": "Acquire-Sync-Organize-Synthesize",
                "description": "Collect references from browser-based discovery tools, sync them into Zotero, organize them by project logic, then hand off to review workflows.",
            },
            {
                "title": "Zotero-As-Source-of-Truth",
                "description": "Treat Zotero as the canonical library layer; browser skills gather and export, while Zotero MCP powers management, annotation, and synthesis.",
            },
        ],
        "checklists": [
        ...
        "reference_guides": [
            {
                "path": "references/stack-setup.md",
                "label": "installation sequence, host matrix, and third-party component setup",
                "when": "read before configuring the stack or running the installer script",
            },
            {
                "path": "references/stack-playbooks.md",
                "label": "batch collection, project tagging, and review-generation playbooks",
                "when": "read when moving from installation to actual literature operations",
            },
        ],
    },
    {
...
PACK_DETAILS_BY_ID = {
    ...
    "literature-stack": {
        ...
        "workflow_steps": [
            "先判断当前宿主是 Claude Code、Codex，还是两者协同使用。",
            "安装 Zotero MCP，并确认 Zotero 桌面端和本地 API 可用。",
            "在 Claude Code 侧接入 Chrome DevTools MCP，再安装 `cnki-skills` 和 `gs-skills`。",
            "把检索、全文链接、导出和入库统一收束到 Zotero 这一层，而不是让浏览器工具长期承担读写真源。",
            "为项目建立 collection、tag、note 和 duplicate 处理规则。",
            "在 Zotero collection 清理完成后，再交给 `dan-literature` 或 `dan-review-paper` 生成综述产出。",
        ],
        "decision_rules": [
        ...
        "corpus_buckets": [
            {"label": "文献采集与检索", "keywords": ["文献", "检索", "关键词", "数据库", "引用"]},
            {"label": "整理表与项目管理", "keywords": ["整理", "表格", "归纳", "分类", "管理"]},
            {"label": "综述准备与综合", "keywords": ["综述", "review", "文献综述", "脉络"]},
            {"label": "工具与辅助流程", "keywords": ["工具", "网站", "AI", "模板"]},
        ],
    },
    "question-gap": {
        "situations": [
